...
| ④ 위험기상(SIGMET/PIREP) | 근거 패널 칩(TS·ICE·TURB) + 루트 교차 시 지도 경고 마커 | 조건부 | **2단계로 이관**(사유 동일 — F1~F10에 대응 항목 없음, 기상서버 `isigmet`/`pirep` MCP 도구는 있으나 지도 프론트 연동 미구현) |
| ⑤ 기상 레이더(RainViewer) | 토글 레이어 + 재생 바(과거 2h). 결정 포커스 기본 OFF, 온디맨드 | 토글 | **2단계로 이관**(사유 동일 — 사용자 확정 2026-07-22, [result/review-2026-07-22.md §D-3](../result/review-2026-07-22.md)) |
